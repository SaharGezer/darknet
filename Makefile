...
CFLAGS+= -DGPU
ifeq ($(OS),Darwin) #MAC
LDFLAGS+= -L/usr/local/cuda-10.2/lib /usr/include -lcuda -lcudart -lcublas -lcurand
else
LDFLAGS+= -L/usr/local/cuda-10.2/lib64 /usr/include -lcuda -lcudart -lcublas -lcurand
endif
endif
